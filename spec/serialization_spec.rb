...
RSpec.describe 'serialization' do
  it "can serialize simple structure" do
    ...
    buffer.serialize.pack('c*').unpack('H*').first == "99ace6c721db293b0ed5b487e6d6111f22a8c55d2a1b7606b6fa6e6c29671aa13000000006000000d204000000000000416e64726577"
  end
  ...
  it "can serialize array" do
    ...
    puts buffer.serialize.pack('c*').unpack('H*').first == "0000000003000000010002000300"
  end
  ...
  it "can sign a message" do
    ...
    message.sign(secret, data) == signature
  end
end
